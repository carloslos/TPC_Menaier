        ...
        public void Go()
        {
            new InvoicerApi(SizeOption.A4, OrientationOption.Landscape, "$")
                ...
                .Items(new List<ItemRow> { 
                    ItemRow.Make("Nexus 6", "Midnight Blue", (decimal)1, (decimal)166.66, (decimal)199.99),
                    ItemRow.Make("24 Months (£22.50pm)", "100 minutes, Unlimited texts, 100 MB data 3G plan with 3GB of UK Wi-Fi", (decimal)1, (decimal)360.00, (decimal)432.00),
