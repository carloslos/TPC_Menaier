...
CREATE TABLE LOTES
(
	IDLOTE BIGINT IDENTITY(120000000,1) NOT NULL PRIMARY KEY,
...
(
	IDPXV BIGINT NOT NULL IDENTITY(130000000,1) PRIMARY KEY,
...
(
	IDPXV BIGINT NOT NULL FOREIGN KEY REFERENCES PRODUCTOS_X_VENTA(IDPXV),
...
INSERT INTO EMPLEADOS(NOMBRE,APELLIDO,DNI,FECHANAC,USUARIO,PASS,TIPOPERFIL,EMAIL,ACTIVO) VALUES ('Carlos','Menaier',15631367,'11/03/1995','admin','21232f297a57a5a743894a0e4a801fc3',1,'cmenaier@gmail.com',1)
INSERT INTO EMPLEADOS(NOMBRE,APELLIDO,DNI,FECHANAC,USUARIO,PASS,TIPOPERFIL,EMAIL,ACTIVO) VALUES ('Maximiliano','Sar Fernandez',28865175,'09/11/1978','supervisor','09348c20a019be0318387c08df7a783d',2,'msarfernandez@gmail.com',1)
INSERT INTO EMPLEADOS(NOMBRE,APELLIDO,DNI,FECHANAC,USUARIO,PASS,TIPOPERFIL,EMAIL,ACTIVO) VALUES ('Maggie','Pacheco',18975273,'10/01/1980','vendedor','0407e8c8285ab85509ac2884025dcf42',3,'mpacheco@gmail.com',1)
...
INSERT INTO PRODUCTOS(IDMARCA,IDTIPOPRODUCTO,DESCRIPCION,STOCK,STOCKMIN,GANANCIA,ACTIVO) VALUES (40000000,50000000,'Alfajor Sabor Mani',0,24,25,1),(40000002,50000001,'Milanesas de soja',0,25,20,1)           
INSERT INTO PRODUCTOS(IDMARCA,IDTIPOPRODUCTO,DESCRIPCION,STOCK,STOCKMIN,GANANCIA,ACTIVO) VALUES (40000003,50000007,'Fideos TriColor',0,30,18,1),(40000004,50000002,'Tapas de empanada',0,20,22,1)           
INSERT INTO PRODUCTOS(IDMARCA,IDTIPOPRODUCTO,DESCRIPCION,STOCK,STOCKMIN,GANANCIA,ACTIVO) VALUES (40000006,50000003,'Papas Fritas 180gr',0,32,30,1),(40000010,50000004,'Coca Cola 2,5L',0,24,26,1)     
INSERT INTO PRODUCTOS(IDMARCA,IDTIPOPRODUCTO,DESCRIPCION,STOCK,STOCKMIN,GANANCIA,ACTIVO) VALUES (40000019,50000000,'Barra Chocolate 200gr',0,24,25,1),(40000001,50000002,'Yoghurt Almendras',0,12,36,1)     
...
-- INSERT INTO LOTES(IDCOMPRA,IDPRODUCTO,UNIDADESP,UNIDADESE,COSTOPU,ACTIVO) VALUES (90000000,70000000,24,20,25.99,1)
...
-- INSERT INTO PRODUCTOS_X_VENTA(IDVENTA,IDPRODUCTO,PRECIOPU,CANTIDAD) VALUES (80000000,70000000,32.489,4)

-- EMPLEADOS 		 - 10000000
-- PROVEEDORES 		 - 20000000
-- CLIENTES 		 - 30000000
-- MARCAS 			 - 40000000
-- TIPOSPRODUCTO	 - 50000000
-- CONTACTOS 		 - 60000000
-- PRODUCTOS 		 - 70000000
-- VENTAS			 - 80000000
-- COMPRAS			 - 90000000
-- TELEFONOS 		 - 100000000
-- DOMICILIOS 		 - 110000000
-- LOTES 			 - 120000000
-- PRODUCTOS_X_VENTA - 130000000

/*
DELETE FROM LOTES_X_VENTA
DELETE FROM PRODUCTOS_X_VENTA
DELETE FROM LOTES
DELETE FROM COMPRAS
DELETE FROM VENTAS
*/